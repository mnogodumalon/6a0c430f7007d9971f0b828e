...
const KATZENVERWALTUNG_FIELDS = [
  ...
  { key: 'impfstatus', label: 'Impfstatus', type: 'lookup/select', options: [{ key: 'vollstaendig', label: 'Vollständig geimpft' }, { key: 'teilweise', label: 'Teilweise geimpft' }, { key: 'nicht_geimpft', label: 'Nicht geimpft' }, { key: 'unbekannt_impf', label: 'Unbekannt' }] },
  ...
  { key: 'name', label: 'Name der Katze', type: 'string/text' },
];
const ZUSATZLEISTUNGEN_FIELDS = [
  { key: 'leistung_name', label: 'Name der Leistung', type: 'string/text' },
...
const BUCHUNGSVERWALTUNG_FIELDS = [
  ...
  { key: 'katze', label: 'Katze', type: 'applookup/select', targetEntity: 'katzenverwaltung', targetAppId: 'KATZENVERWALTUNG', displayField: 'rasse' },
  { key: 'anreisedatum', label: 'Anreisedatum', type: 'date/date' },
  { key: 'abreisedatum', label: 'Abreisedatum', type: 'date/date' },
  { key: 'box_nummer', label: 'Box-/Zimmernummer', type: 'string/text' },
  { key: 'zusatzleistungen_buchung', label: 'Zusatzleistungen', type: 'multipleapplookup/select', targetEntity: 'zusatzleistungen', targetAppId: 'ZUSATZLEISTUNGEN', displayField: 'leistung_name' },
  { key: 'gesamtpreis', label: 'Gesamtpreis (€)', type: 'number' },
  { key: 'notizen_buchung', label: 'Notizen zur Buchung', type: 'string/textarea' },
];
...
export default function AdminPage() {
  ...
  const getApplookupDisplay = useCallback((entity: EntityKey, fieldKey: string, url?: unknown) => {
    ...
    if (entity === 'buchungsverwaltung' && fieldKey === 'katze') {
      const match = (lists.katzenverwaltungList ?? []).find((r: any) => r.record_id === id);
      return match?.fields.rasse ?? '—';
    }
    if (entity === 'buchungsverwaltung' && fieldKey === 'zusatzleistungen_buchung') {
